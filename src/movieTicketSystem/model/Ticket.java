...
public class Ticket {
	...
	private ArrayList<Theatre> theatres = db.selectAllTheatres();
    ...
    public void print() {
    	...
    	String theaterName= theatres.stream().filter(m->m.getTheatreId() == Ids.get(1)).map(Theatre::getTheatreName).collect(Collectors.toList()).get(0);
